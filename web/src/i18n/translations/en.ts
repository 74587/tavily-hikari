...
export const EN: TranslationShape = {
    ...
    admin: {
      ...
      dashboard: {
        ...
        trendsDescription: 'Charts use fixed today/month windows; yesterday and previous-month comparisons stay complete, with missing buckets left blank.',
      ...
      systemSettings: {
        ...
        helpLabel: 'Show system settings help', form: {
          ...
          apiRebalanceHint: 'Routes Tavily HTTP JSON requests through the upstream-agnostic selector when the per-request rollout bucket matches.',
          ...
          globalIpLimitLabel: 'Global IP limit',
