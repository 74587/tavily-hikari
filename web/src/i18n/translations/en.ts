    ...
    admin: {
      ...
      systemSettings: {
        ...
        form: {
          ...
          gatewaySectionTitle: 'Session affinity and Rebalance', upstreamIdentityTitle: 'Upstream identity and privacy', requestRateLimitLabel: 'Max requests per 5 minutes',
