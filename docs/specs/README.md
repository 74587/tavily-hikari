...
| ID | Title
| 29w25 | 上游密钥详情 Sticky 用户/节点列表 | 待实现 | `29w25-admin-key-sticky-users-nodes/SPEC.md` | 2026-03-16 | many-to-many current bindings, recent-success-first routing, sticky user/node panels |
| Status | Spec | Last | Notes |
| ----: | ------------------------------------------------------ | ---------------- | ---------------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------- |
