...
| ----: | ------------------------------------------------------ | ---------------- | ---------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------ |
| vr67d | LinuxDo 登录复用既有 Token + 强制重登录 + 历史误建自愈 | 已完成（快车道） | `vr67d-linuxdo-token-rebind-relogin/SPEC.md`         | 2026-03-04 | PR #89 ready: token self-heal + user-session revoke migration + POST login flow                  |
