...
| ----: | ------------------------------------------------------ | ---------------- | ---------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------ |
| vr67d | LinuxDo 登录复用既有 Token + 强制重登录 + 历史误建自愈 | 进行中（快车道） | `vr67d-linuxdo-token-rebind-relogin/SPEC.md`         | 2026-03-04 | impl+tests+build done locally; pending fast-track push/PR/checks/review-loop                     |
