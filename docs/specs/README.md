...
| ----: | ---------------------------------------------------- | ---------------- | ---------------------------------------------------- | ---------- | ------------------------------------------------------------------------------------------------ |
| w2t73 | 批量 Key 导入稳定性修复                              | 部分完成（3/4）  | `w2t73-batch-key-upsert-stability/SPEC.md`           | 2026-03-04 | lib hardening + regression test done; pending fast-track PR convergence                          |
