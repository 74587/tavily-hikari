...
- `docs/specs/release-amd64-smoke-hardening/SPEC.md`
...
- `docs/specs/release-amd64-smoke-hardening/SPEC.md`: 记录实现、验证与回填结果

## 计划资产（Plan assets）

- Directory: `docs/specs/release-amd64-smoke-hardening/assets/`
