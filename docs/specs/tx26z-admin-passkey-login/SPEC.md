...
- 当前桌面端完整文字版登录布局：![完整文字版桌面登录页](./assets/admin-login-full-logo-desktop.png)
- 当前移动端紧凑文字版登录布局：![紧凑文字版移动端登录页](./assets/admin-login-compact-logo-mobile.png)
- 当前移动端暗色紧凑文字版登录布局：![暗色紧凑文字版移动端登录页](./assets/admin-login-compact-logo-mobile-dark.png)
